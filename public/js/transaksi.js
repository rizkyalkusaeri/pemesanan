...
vue__WEBPACK_IMPORTED_MODULE_2__.default.filter('currency', function (money) {
  return accounting.formatMoney(money, "Rp ", 2, ".", ",");
});
vue__WEBPACK_IMPORTED_MODULE_2__.default.use((vue_sweetalert2__WEBPACK_IMPORTED_MODULE_1___default()));
new vue__WEBPACK_IMPORTED_MODULE_2__.default({
  ...
  methods: {
    getProduct: function getProduct() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default().get("/api/product/".concat(this.cart.product_id)).then(function (response) {
    ...
    addToCart: function addToCart() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default().post('/api/cart', this.cart).then(function (response) {
        setTimeout(function () {
    ...
    getCart: function getCart() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default().get('/api/cart').then(function (response) {
        _this4.shoppingCart = response.data;
      });
    },
    getAmmount: function getAmmount() {
      var _this5 = this;

      axios__WEBPACK_IMPORTED_MODULE_0___default().get('/api/ammount').then(function (response) {
    ...
    removeCart: function removeCart(id) {
      ...
      this.$swal({
        ...
        if (result.value) {
          axios__WEBPACK_IMPORTED_MODULE_0___default().delete("/api/cart/".concat(id)).then(function (response) {
            _this6.getCart();
    ...
    sendOrder: function sendOrder() {
      ...
      this.errorMessage = '';
      this.message = ''; //jika var customer.email dan kawan-kawannya tidak kosong
      ...
      this.$swal({
        ...
        if (result.value) {
          ...
          axios__WEBPACK_IMPORTED_MODULE_0___default().post('/checkout', _this7.customer).then(function (response) {
            setTimeout(function () {
              //jika responsenya berhasil, maka cart di-reload
              _this7.getCart();

              _this7.getAmmount(); //message di-set untuk ditampilkan
