<div class="main-sidebar">
    <aside id="sidebar-wrapper">
        <div class="sidebar-brand">
            <a href="{{ route('home') }}">Nama Perusahaan</a>
        </div>
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            @if (auth()->user()->role == 'customer')
                <li class="@if (Request::segment(1)=='order' ) active @endif"><a class="nav-link" href="{{ route('order.index') }}"><i class="fas fa-cart-plus"></i>
                        <span>Order</span></a>
                </li>
                <li class="nav-item">
            ...
            @if (auth()->user()->role == 'admin')
                ...
                <li class="@if (Request::segment(1)=='product' ) active @endif"><a class="nav-link" href="{{ route('product.index') }}"><i
                            class="fas fa-file"></i>
                        <span>Produk</span></a></li>
                <li class="@if (Request::segment(1)=='bahan' ) active @endif"><a class="nav-link" href="{{ route('bahan.index') }}"><i class="fas fa-archive"></i>
                        <span>Bahan Baku</span></a></li>
                <li class="@if (Request::segment(1)=='produksi' ) active @endif"><a class="nav-link" href="{{ route('produksi.index') }}"><i
                            class="fas fa-industry"></i>
                        <span>Produksi</span></a></li>
                <li class="@if (Request::segment(1)=='delivery' ) active @endif"><a class="nav-link" href="{{ route('delivery.index') }}"><i
                            class="fas fa-paper-plane"></i>
                        <span>Delivery</span></a></li>
                <li class="@if (Request::segment(1)=='user' ) active @endif"><a class="nav-link" href="{{ route('user.index') }}"><i class="fas fa-user-friends"></i>
