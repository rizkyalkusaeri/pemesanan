...
@section('content')
    <div class="card">
        <form action="{{ route('job.store', [$order->id]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            <label>File Job Order</label>
                            <input type="file" class="form-control" value="{{ old('job') }}" name="job" id="job">
